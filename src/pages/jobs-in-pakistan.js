  ...
  return (
    <Layout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Title */}
        <h1 className="text-4xl font-bold text-center text-blue-600 mb-6">Jobs in Pakistan</h1>
        ...
        <div className="text-center">
          ...
          <div className="mb-4">
            <a
              href="https://www.facebook.com/profile.php?id=100087877179793" // Replace with your actual Facebook page URL
              target="_blank"
            ...
            <p className="mt-2">Click and follow our Facebook page containing job ads of Pakistan.</p>
          </div>
          ...
          <div className="mb-4">
            ...
            <p className="mt-2">Click and follow our WhatsApp Channel containing job ads of Pakistan.</p>
          </div>
